...
<div class="card">
<h5 class="card-header">Order       <a href="{{route('order.pdf',$order->id)}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Cetak PDF</a>
  </h5>
  <div class="card-body">
    @if($order)
            ...
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                      ...
                      <td> : @if($order->payment_method=='cod') COD (Cash on Delivery) @else Transfer @endif</td>
                    </tr>
                    <tr>
                        <td>Status Bayar</td>
