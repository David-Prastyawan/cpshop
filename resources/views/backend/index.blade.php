...
@section('title','CP-SHOP | DASHBOARD')
@section('main-content')
<div class="container-fluid">
  @include('backend.layouts.notification')
  <!-- Page Heading -->
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dasbor Admin</h1>
  </div>
  ...
  <script type="text/javascript">
    ...
    function number_format(number) {
      // Menggunakan fungsi JavaScript untuk memformat angka ke format Rupiah
              ...
              yAxes: [{
                ticks: {
                  ...
                  callback: function(value, index, values) {
                    // Memanggil fungsi number_format untuk memformat angka ke format Rupiah
  ...
  <!-- fungsi dan format default line chart dan format mata uang dolar, diganti tanpa menggunakan rumus karena
  penggunaan objek Intl.NumberFormat dapat memberikan solusi yang lebih kuat dan terintegrasi secara internasional. -->
