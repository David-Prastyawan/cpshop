...
@section('title','CP-SHOP | Banner Edit')
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Nama Banner <span class="text-danger">*</span></label>
        <input id="inputTitle" type="text" name="title" placeholder="Masukkan nama banner"  value="{{$banner->title}}" class="form-control">
        @error('title')
