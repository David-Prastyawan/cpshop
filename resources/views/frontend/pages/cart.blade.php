						...
						<div class="col-lg-4 col-md-7 col-12">
							<div class="right">
								<ul>
									...
									@endphp
									@if(session()->has('coupon'))
									<li class="last" id="order_total_price">Harga Bayar<span>Rp {{ number_format($total_amount, 0, ',', '.') }}</span></li>
									@else
									<li class="last" id="order_total_price">Harga Bayar<span>Rp.{{ number_format($total_amount, 0, ',', '.') }}</span></li>
									@endif
								</ul>
								<div class="button5">
									<a href="{{route('checkout')}}" class="btn">Proses Pemesanan</a>
...
<script>
	$(document).ready(function() {
		$('.shipping select[name=shipping]').change(function() {
			...
			// Mengubah format ke Rupiah
			let formattedTotal = 'Rp ' + number_format(subtotal + cost - coupon, 0, ',', '.');
