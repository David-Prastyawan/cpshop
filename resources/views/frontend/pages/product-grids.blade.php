            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="blog-single.html">Daftar Produk</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-8 col-12">
                    ...
                    <div class="row">
                        ...
                        @endforeach
                        @else
                        <h4 class="text-warning" style="margin:100px auto;">Belum ada produk.</h4>
                        @endif
