...
class PostCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Kategori artikel berhasil ditambahkan');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Kategori artikel berhasil di edit');
        }
        else{
            request()->session()->flash('error','Coba lagi!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Kategori artikel berhasil dihapus');
        }
        else{
            request()->session()->flash('error','Error saat menghapus kategori artikel');
        }
        return redirect()->route('post-category.index');
    }
}
