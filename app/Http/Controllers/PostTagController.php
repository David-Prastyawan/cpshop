...
class PostTagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Label artikel berhasil ditambahkan');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Label artikel berhasil di edit');
        }
        else{
            request()->session()->flash('error','Coba lagi');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Error saat menghapus');
        }
        return redirect()->route('post-tag.index');
    }
}
